...
def add_element(xmlFile):  # print in stdout well, do that write it on file.

    with open(xmlFile, "br") as targetFile:
        xml = targetFile.read()

    objXml = objectify.fromstring(xml)
...
def data_harvester():
    ...
    return(title, screenwriter, producer, director, protagonist, summary)

if __name__ == "__main__":
    my_Parse("peliculas.xml")
